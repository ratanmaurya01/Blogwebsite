  ...
  return (
    <div>
      <div className="text-center shadow-sm">
        <nav aria-label="Page navigation example sm-ml-0">
          <ul class="inline-flex space-x-px text-base h-10">
            <li>
              <a
                href="#"
                class="flex items-center justify-center px-2 h-10 ms-0 
                leading-tight text-gray-500 bg-white border border-e-0
            ...
            <li>
              <a
                href="#"
                aria-current="page"
                class="flex items-center justify-center px-4 h-10 text-blue-600 border leading-tight
